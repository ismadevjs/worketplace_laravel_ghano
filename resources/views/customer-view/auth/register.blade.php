                        ...
                        <form class="needs-validation_" id="sign-up-form" action="{{ route('customer.auth.register') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select form-control dayras" id="dayras" name="dayras"
                                            aria-label="Default select example">
                                            <option selected>-</option>
                                        </select>
                                    </div>
                            ...
                            <div class="form-group d-flex flex-wrap justify-content-between">
                                ...
                                <div class="form-group mb-1">
                                    ...
                                    <label class=""
                                        for="remember">{{ trans('messages.i_agree_to_Your_terms') }}<a
                                            class="font-size-sm" target="_blank" href="{{ route('terms') }}">
                                            {{ trans('messages.regle_util') }}
                                        </a></label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 mt-5">
                                    <div class="text-right">
                                        <button class="btn btn-primary col-12" type="submit" id="sign_in" disabled><i
