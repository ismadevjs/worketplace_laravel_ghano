    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="col-sm">
                    <h1 class="page-header-title">{{ trans('messages.Seller') }}
                        <span class="badge badge-soft-dark ml-2">{{ \App\User::where('seller', 1)->count() }}</span>
                    </h1>
                </div>
            </div>
            <!-- End Row -->
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="#">{{ trans('messages.Seller') }}
                            {{ trans('messages.List') }}
                        </a>
                    </li>
                </ul>
                        ...
                        <form action="javascript:">
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch" type="search" class="form-control"
                                    placeholder="Search seller" aria-label="Search seller">
                            </div>
                            <!-- End Search -->
                        </form>
                    </div>
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th>{{ trans('messages.block') }} / {{ trans('messages.unblock') }}</th>
                        ...
                        @foreach ($customers as $key => $customer)
                            @if ($customer->seller == true)
                                <tr class="">
                                    ...
                                    <td>
                                        <label class="switch">
                                            <input type="checkbox" class="status" id="{{ $customer['id'] }}"
