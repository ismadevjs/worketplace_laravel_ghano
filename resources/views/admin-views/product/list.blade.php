                ...
                <div class="card-body" style="padding: 0">
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <?php $product_founded = DB::table('notifications_jdidas')->where('num', $p->id)->first()?>
                            ...
                            @endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/product/{{$p->slug}}"  target="_blank" class="btn btn-success" > Produit lien </a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary btn-sm"
                                           href="{{route('admin.product.view',[$p['id']])}}">
                                            <i class="tio-eye"></i>{{trans('messages.Review')}}
                                        </a>
