                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6" id="commission">
                                        <label
                                            class="control-label">{{trans('messages.Commission')}}</label>
                                        <input type="text"  value={{ $product->commision }} step="1"
                                               placeholder="{{trans('messages.Commission')}}"
                                               name="current_commission" class="form-control" required>
                                    </div>
                                </div>
                            </div>
...
@push('script_2')
    ...
    <script>
        var imageCount = {{8-count(json_decode($product->images))}};
