                ...
                <div class="details">
                    ...
                    <div class="mb-3 text-success" style="font-size : 20px">
                       <img src="{{asset('public/assets/front-end/img/commission.jpeg')}}" width="20" height="20">
                        ...
                        <strong id="commission" > {{ ($product->commision / 100) * ($product->unit_price) }} DA </strong>
                    ...
                    <div class="mb-3 " style="font-size : 20px">
                      ...
                      <strong id="categories" > 
                        <?php $cc = json_decode($product->category_ids); ?>
                        
                        @foreach($categories as $category)
                            @if($category->id == $cc[0]->id)
                                {{$category->name}}
                            @endif
                        @endforeach
                        </strong>
                                     ...
                                     <div class="container pb-4">
                                        <div class="row">
                                            <div class="col text-center">
                                                <button onclick="copyToClipboard('#markascopy')" class="btn btn-primary hidden-lg-down " id="copy">Copier le Contenus</button>
                                            </div>
                                        </div>
                                        </div>
                                   
                                  <div class="col-lg-12 col-md-12 @if(is_rtl($product['details'])) text-right @else text-left @endif" id="markascopy">
                                      {!! $product['details'] !!}
                                  </div>
                              </div>
                          </div>
