    ...
    <div class="container pb-5 mb-2 mb-md-4 mt-3">
        <div class="row">
            ...
            <section class="col-lg-9 col-md-9">
                    ...
                    <div class="payment border-top mt-3 mb-3  table-responsive">
                        ...
                        <table class="table table-borderless">
                            ...
                            @foreach ($order_details as $key=>$detail)
                                ...
                                <tr>
                                    <div class="row">
                                        <div class="col-md-6"
                                            ...
                                            <td width="40%" class="for-glaxy-name" style="vertical-align:middle">
                                                <a href="{{route('product',[$product['slug']])}}">
                                                    {{isset($product['name']) ? $product['name'] : ''}}
                                                </a><br>
                                                <span class="text-warning" style='font-weight : bold;'> {{(($detail->price / 100) * $product['commision']) * $detail->qty}} DA</span>
                                                @if ($detail->variant)  <span>{{__('messages.Variant')}} : </span><br> @endif
                                                {{$detail->variant}}
                                               
                                                 
                                            </td>
                                        </div>
                                        <td width="20%" style="vertical-align:top; font-size: 14pt;">
                                          
                                          <span style=""> {{ $detail->qty }} Pcs </span>
                                        ...
                                        <div class="col-md-6">
                                            <td width="30%">
                                                <div class="text-right">
                                                    <span
                                                        class="font-weight-bold amount" style="font-size : 16pt;">{{\App\CPU\Helpers::currency_converter($detail->price)}} </span>
                                                    <br>
                                                </div>
                                            </td>
                                        </div>
                                ...
                                @php($total_comm += (($detail->price / 100) * $product['commision']) * $detail->qty)
                ...
                <div class="row d-flex justify-content-end">
                    <div class="col-md-12 col-lg-6">
                        ...
                        <tr class="border-top border-bottom">
                                <td>
                                    <div class="text-left"><span
                                            class="">{{trans('messages.comission')}}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="text-right"><span
                                            class="">{{\App\CPU\Helpers::currency_converter($total_comm)}} </span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                ...
                @foreach($shipping_addr as $key=>$addrs)
                    @if($order->shipping_address == $addrs->id)
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <td>
                                    <div class="text-left"><span
                                            class="product-qty ">{{trans('messages.contact_person_name')}}</span></div>
                                </td>
                                <td>
                                    <div class="text-right text-uppercase font-weight-bold text-black"><span>{{$addrs->contact_person_name}}</span>
                                    </div>
                                </td>
                            </tr>
                             ...
                             <tr>
                                <td>
                                    <div class="text-left"><span
                                            class="product-qty ">{{trans('messages.Phone')}} </span>
                                    </div>
                                </td>
                                <td>
                                    <div class="text-right text-uppercase font-weight-bold">
                                        <span>{{$addrs->phone}}</span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <div class="text-left"><span
                                            class="product-qty ">{{trans('messages.country')}} </span>
                                    </div>
                                </td>
                                <td>
                                    <div class="text-right text-uppercase font-weight-bold">
                                         ...
                                         @foreach($countries as $country)
                                            @if ($addrs->country == $country->id)
                                            
                                            
                                                <span> {{$country->wilaya}}</span>
                                            @endif
                                           @endforeach
                            ...
                            <tr>
                                <td>
                                    <div class="text-left"><span
                                            class="product-qty ">{{trans('messages.state')}}</span>
                                            
                                </td>
                                <td>
                                    <div class="text-right text-uppercase font-weight-bold">
                                        <span> @foreach($states as $state)
                                       
                                           @if ($addrs->city == $state->id)
                                                 <span> {{$state->dayra}}</span>
                                            @endif
                             ...
                             <tr>
                                <td>
                                    <div class="text-left"><span
                                            class="product-qty ">{{trans('messages.address')}}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="text-right text-uppercase font-weight-bold ">
                                        <span>{{$addrs->address}}</span>
                                    </div>
                                </td>
                            </tr>
