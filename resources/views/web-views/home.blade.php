...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-3 col-md-4 pb-4 mt-3">
                <div  class="deal_of_the_day" style="opacity: 1;background: #fff;border-radius: 3px;  text-align: center; text-transform: uppercase;">
                    @if(isset($deal_of_the_day))
                        ...
                        <div class="pt-3 pb-2" style="text-align: center;">
                            <button class="btn btn-dark bg-light"
                    ...
                    @else
                        ...
                        @if(isset($product))
                            <h1 style="color: {{$web_config['primary_color']}}"> {{ trans('messages.recommended_product') }}</h1>
                            ...
                            <div style="text-align: center; padding-top: 60px; color: black;" class="pb-2">
                                <button class="btn text-white font-weight-bold" style="background: {{$web_config['primary_color']}}" onclick="location.href='{{route('product',$product->slug)}}'">
            ...
            <div class="col-xl-9 col-md-8">
                ...
                <!--isdo here to added latest products-->
                
                
                   <div class="row mt-2 mb-3">
               
                        @foreach($latest_products as $product)
                         <?php $xx = json_decode($product['category_ids'])?>
                         @foreach($categories as $cat) 
                            @if($cat->id == intval($xx[0]->id) && $cat->home_status == 1)
   ...
   @foreach($home_categories as $category)
    ...
    @if(count(\App\CPU\CategoryManager::products($category['id'])) > 0)
    @if ($category['home_status'] == 1 )
    <section class="container">
        <!-- Heading-->
        <div class="row">
