        ...
        <div class="row pt-2">
            <div class="col-12">
                <select class="form-control" id="shipping_method_id" onchange="set_shipping_id(this.value)">
                    <option value="0">{{trans('messages.choisir_la_livraison')}}</option>
            ...
            <div class="col-6">
                <a href="{{route('home')}}" class="btn btn-primary">
                    <i class="fa fa-backward"></i> {{ trans('messages.continue_shopping') }}
                </a>
            </div>

            <div class="col-6">
                <a href="{{route('checkout-details')}}" class="btn btn-primary pull-right">
                    {{ trans('messages.checkout') }} <i class="fa fa-forward"></i>
                </a>
            </div>
        </div>
    </section>
