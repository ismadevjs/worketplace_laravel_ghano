                ...
                <div class="d-none d-md-block">
                    <form class="position-relative">
                      ...
                      <div class="input-group input-group-merge input-group-borderless input-group-hover-light navbar-input-group">
                        ...
                        <input type="search" class="js-form-search form-control" id="search-bar-input" placeholder="Search" aria-label="Search in front" data-hs-form-search-options="{
                               ...
                               <div class='mr-2'></div>
                               <a href='https://worketplace.com/admin/orders/list/all' class="btn btn-primary mr-2"><i class="tio-shopping-cart-outlined nav-icon"></i></a>
                               <a href='https://worketplace.com/admin/sellers/withdraw_list' class="btn btn-success mr-2"><i class="tio-atm-outlined nav-icon"></i></a>
                               <a href='https://worketplace.com/admin/business-settings/language' class="btn btn-warning mr-2"><i class="tio-book-opened nav-icon"></i></a>
                               <a href='https://worketplace.com/admin/customer/seller' class="btn btn-danger mr-2"><i class="tio-users-switch nav-icon"></i></a>
                               <a href='https://worketplace.com/admin/customer/list' class="btn btn-secondary mr-2"><i class="tio-poi-user nav-icon"></i></a>
