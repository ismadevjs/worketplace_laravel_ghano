                ...
                <div class="navbar-vertical-content mt-2">
                                        ...
                                        <a class="nav-link " href="{{route('admin.orders.list',['confirmed'])}}"
                                           title="">
                                            ...
                                            {{trans('messages.confirmed')}}
                                                <span class="badge badge-soft-secondary text-white badge-pill ml-1">
                    ...
                    <!--business section ends here-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('user_section'))
                            <li class="nav-item {{(Request::is('admin/customer/list') || Request::is('admin/customer/seller'))?'scroll-here':''}}">
                                <small class="nav-subtitle" title="">{{trans('messages.user_section')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>

                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/customer/seller')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.customer.seller')}}">
