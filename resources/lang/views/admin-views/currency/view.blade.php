        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.currency.withdraw')}}" method="post">
                            @csrf
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="numbe" name="limite" class="form-control"
                                               id="withdraw" value="{{$retrait->limite}}" placeholder="Enter currency Name">
                                    </div>
                            ...
                            <div class="form-group text-center">
                                <button type="submit" id="add" class="btn btn-primary text-capitalize"
                                        style="color: white">
                                    <i class="tio-add"></i> {{trans('messages.update')}}
                                </button>
                            </div>
                        </form>
                    </div>
