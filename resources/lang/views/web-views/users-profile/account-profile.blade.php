                            ...
                            <div class="row photoHeader">
                                ...
                                <div class="col-md-10">
                                    <h5 class="font-name">{{ $customerDetail->f_name . ' ' . $customerDetail->l_name }}
                                        @if ($shop) <span style="color : green">({{ trans('messages.Seller') }})</span> @endif</h5>
                                ...
                                <div class="card-body ml-3">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" type="text" id="phone" name="phone"
                                    ...
                                    @if ($shop)
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="ccp">{{ trans('messages.CCP') }} </label>
                                                <input type="text" class="form-control" type="text" name="CCP" id="ccp"
                                                    value="{{ $customerDetail['CCP'] }}">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="cle">{{ trans('messages.KEY') }} </label>
                                                <input type="text" class="form-control" type="text" id="phone" name="CLE"
                                                    value="{{ $customerDetail['CLE'] }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="password-toggle">
                                                ...
                                                <label class="password-toggle-btn">
                                                    ...
                                                    <span class="sr-only">{{ trans('messages.Show') }}
                                                        {{ trans('messages.password') }} </span>
                                                </label>
                                            </div>
                                        </div>
                                                ...
                                                <div>
                                                    <label class="password-toggle-btn">
                                                        ...
                                                        <i class="czi-eye password-toggle-indicator"
                                                            ...
                                                            class="sr-only">{{ trans('messages.Show') }}
                                                            {{ trans('messages.password') }} </span>
                                                    </label>
                                                </div>
                                    ...
                                    <button type="submit"
                                        class="btn btn-primary float-right">{{ trans('messages.update') }}
                                        {{ trans('messages.Informations') }} </button>
                                </div>
                            </div>
                        </form>
                    </div>
