...
<div class="sidebarR col-lg-3 col-md-3">
    ...
    <div class="price_sidebar rounded-lg box-shadow-sm" id="shop-sidebar" style="margin-bottom: -10px;">
        ...
        {{-- <div class="pb-0">
            ...
            <div class=" sidebarL">
                <h3 class="widget-title btnF" style="font-weight: 700;">
                    <a class="{{Request::is('user-account*')?'active-menu':''}}" href="{{route('bank-account')}}">
                        {{trans('messages.bank_account')}}
                    </a>
                </h3>
                <div class="divider-role"
                     style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;">
        ...
        <div class="pb-0">
            ...
            <div class=" sidebarL">
                <h3 class="widget-title btnF" style="font-weight: 700;">
                    <a class="{{(Request::is('withdraw*'))?'active-menu':''}}"
                       href="{{ route('withdraw') }}">{{trans('messages.Withdraw')}}</a></h3>
                <div class="divider-role"
                     style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;">
                </div>
            </div>
 ...
 @php($shop=\App\Model\Shop::where('seller_id', auth('customer')->id())->first())
                ...
                <div class="pb-0">
                    ...
                    <div class=" sidebarL">
                        <h3 class="widget-title btnF" style="font-weight: 700;">
                            <a href='{{ Request::root() }}/shop/apply' class="text-danger">
                                {{trans('messages.Become a')}} {{trans('messages.seller')}}</h3>
                        <div class="divider-role"
                            style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;">
                        </div>
                    </div>
