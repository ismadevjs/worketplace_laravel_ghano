...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'withdraw', 'as' => 'withdraw.', 'middleware' => ['module:user_section']], function () {
            ...
            // Route::post('confirm-withdraw', 'WithdrawController@confirmWithdraw')->name('confirm-withdraw');
        ...
        Route::group(['prefix' => 'wilayas', 'as' => 'wilayas.', 'middleware' => ['module:product']], function () {
            Route::get('add-new', 'BrandController@add_new')->name('add-new');
            Route::post('add-new', 'BrandController@store');
            Route::get('list', 'BrandController@list')->name('list');
            Route::get('update/{id}', 'BrandController@edit')->name('update');
        ...
        Route::group(['prefix' => 'currency', 'as' => 'currency.', 'middleware' => ['module:business_settings']], function () {
            ...
            Route::post('withdraw', 'CurrencyController@withdraw')->name('withdraw');
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['module:user_section']], function () {
            ...
            Route::get('seller', 'CustomerController@seller')->name('seller');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.', 'middleware' => ['module:order']], function () {
            ...
            Route::get('download-excel-confirmed', 'OrderController@download_excel_confirmed')->name('download-excel-confirmed');
            Route::post('enexpedition', 'OrderController@enexpedition')->name('enexpedition');
            Route::post('mafhatch', 'OrderController@mafhatch')->name('mafhatch');
        });
