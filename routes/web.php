...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('withdraw', 'UserProfileController@withdraw')->name('withdraw');
    Route::post('withdraw-post', 'UserProfileController@withdrawPost')->name('withdraw-post');
    ...
    Route::get('account-oder-pending', 'UserProfileController@account_oder_pending')->name('account-oder-pending');
    Route::get('account-oder-processing', 'UserProfileController@account_oder_processing')->name('account-oder-processing');
    Route::get('account-oder-delivered', 'UserProfileController@account_oder_delivered')->name('account-oder-delivered');
    Route::get('account-oder-confirmed', 'UserProfileController@account_oder_confirmed')->name('account-oder-confirmed');
    Route::get('account-oder-canceled', 'UserProfileController@account_oder_canceled')->name('account-oder-canceled');
    ...
    Route::get('bank-account', 'UserProfileController@bank_account')->name('bank-account');
...
// //Seller shop apply for customer added by isdo
//     Route::get('/', 'RegisterController@create')->name('apply');
//     Route::post('apply', 'RegisterController@store');
