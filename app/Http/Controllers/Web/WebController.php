...
class WebController extends Controller
{
    ...
    {   
        ...
        $latest_products = Product::with(['reviews'])->active()->orderBy('updated_at', 'desc')->take(8)->get();
        ...
        return view('web-views.home', compact('featured_products', 'topRated', 'bestSellProduct', 'latest_products', 'categories', 'brands', 'deal_of_the_day', 'top_sellers', 'home_categories','marks', 'categories1', 'ismails'));
    }
    ...
    public function product($slug)
    {
        ...
        if ($product != null) {
            ...
            return view('web-views.products.details', compact('product', 'countWishlist', 'countOrder', 'relatedProducts', 'deal_of_the_day','categories', 'marks'));
        }
    ...
    public function products(Request $request)
    {
        ...
        if ($request['data_from'] == 'search') {
            ...
            $query = Product::with(['reviews'])->active()->where('name', 'like', "%{$request['name']}%");
